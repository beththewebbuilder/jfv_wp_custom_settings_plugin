...
function create_review_post() {
	...
	register_taxonomy_for_object_type( 'category', 'review_post' );
	register_taxonomy_for_object_type( 'post_tag', 'review_post' );
}
add_action( 'init', 'create_review_post' );

function add_review_fields_meta_box() {
	add_meta_box(
		'review_fields_meta_box', // $id
		'Review Fields', // $title
		'show_review_meta_box', // $callback
		'review_post', // $screen
		'normal', // $context
		'high' // $priority
	);
}
add_action( 'add_meta_boxes', 'add_review_fields_meta_box' );

function show_review_meta_box() {
  global $post;
  ...
  function save_review_fields_meta( $post_id ) {
    // verify nonce
  ...
  add_action( 'save_post', 'save_review_fields_meta' );
